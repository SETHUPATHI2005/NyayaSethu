...
# ── Lazy imports so the app starts even without GPU deps ──
...
# ── Fallback in-memory legal corpus ──
FALLBACK_CORPUS = [
    {
    ...
    },
    {
        ...
        "source": "Constitution of India — Articles 19, 21, 32, 226",
    ...
    },
    {
        ...
        "source": "PM-KISAN Scheme — Government of India",
        "topic": "schemes",
        "acts": ["PM-KISAN"]
    },
    {
    ...
    },
    {
        ...
        "source": "Code of Criminal Procedure, 1973 — Section 154",
        "topic": "criminal",
        "acts": ["CrPC, 1973"]
    },
]
